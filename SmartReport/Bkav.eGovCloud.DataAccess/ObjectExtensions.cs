...
namespace Bkav.eGovCloud.DataAccess
{
    ...
    public static class ObjectExtensions
    {
        ...
        public static DataTable ToDataTable(this IDataReader rdr)
        {
            ...
            //HopCV: 011115
            //Khong hieu tai sao dung ham Load chuyen thanh DataTable khoong dc?
            var result = new DataTable();
            var listCols = new List<DataColumn>();
            foreach (DataRow drow in dtSchema.Rows)
            {
                string columnName = System.Convert.ToString(drow["ColumnName"]);
                Type columnDatatype = (System.Type)drow["DataType"];
        ...
        /// </summary>
        public static List<ExpandoObject> ToExpandoList(this IDataReader rdr)
        {
