...
{
    internal class PdfToImage64
    {
        #region Static

        private const string GhostScriptDLLName = "gsdll64.dll";
        private const string GhostScriptKernel = "kernel64.dll";
        ...
        [DllImport("kernel64.dll", EntryPoint = "RtlMoveMemory")]
        private static extern void CopyMemory(IntPtr Destination, IntPtr Source, uint Length);

        #endregion Windows Import
        ...
        #endregion Fonts related variables thanks to devalv
        ...
        #endregion Fonts related thanks to devalv

        #endregion Proprieties

        #region Init

        public PdfToImage64(IntPtr objHandle)
        {
        ...
        /// <param name="presetParameters">presetParameters</param>
        ...
        #endregion Menage Standard Input & Standard Output
        ...
        private bool ExecuteGhostscriptCommand(string[] sArgs)
        {
            ...
            #endregion Convert Unicode strings to null terminated ANSI byte arrays
            ...
            #endregion Create a new istance of the library!
        ...
        private void SaveOutputToImage(object sender, System.Diagnostics.DataReceivedEventArgs e)
        {
