...
function getFileBase64TmpForWrite(writingFileId) {	
	var tmp = '';
	if(write_tmp_base64[writingFileId].length > maxLengthOfBase64) {
		tmp = write_tmp_base64[writingFileId].substr(0, maxLengthOfBase64);
		write_tmp_base64[writingFileId] = write_tmp_base64[writingFileId].substr(maxLengthOfBase64);
	} else {
