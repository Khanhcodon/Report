define([
    ...
    var Tabs = Backbone.View.extend({
                ...
                this.model.add(
                    {
                        ...
                        icon: 'report.png',
                        href: 'report',
                        url: 'http://smartnation.bkav.com/reportviewer/ReportGeneral?theme=shine&reportId=255',
                        hasCloseButton: true,
                        type: tabType.report
                    });
            }
        ...
        addSurvey: function (id, title, relationId, isPacket, attachment, contentHTML, callback, info, relationType) {
            /// <summary>
            /// Tab thêm mới phiếu khảo sát
            /// </summary>
            /// <param name="id">DoctypId</param>
            /// <param name="title">Tiêu đề tab</param>
            /// <param name="relationId">DocumentCopyId của văn bản gốc: sử dụng cho trường hợp trả lời văn bản.</param>
        ...
        _insertContentDocument: function () {
            ...
            var openDocumentCallback = function (DocumentView) {
                var documentView = new DocumentView({
                    ...
                    survey: that.model.survey || false
                });
