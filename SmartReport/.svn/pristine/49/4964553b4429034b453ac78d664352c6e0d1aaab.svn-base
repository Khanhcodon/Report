 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/cr-1.5.0/fh-3.1.4/r-2.2.2/rg-1.1.0
 *
 * Included libraries:
 *   DataTables 1.10.18, ColReorder 1.5.0, FixedHeader 3.1.4, Responsive 2.2.2, RowGroup 1.1.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.18/cr-1.5.0/fh-3.1.4/r-2.2.2/rg-1.1.0",
