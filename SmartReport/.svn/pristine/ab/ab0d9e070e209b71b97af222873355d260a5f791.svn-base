...
namespace Bkav.eGovCloud.Business.Tasks
{
    ...
    /// </summary>
    public class ResetIncreateHSMCJob : IeGovJob
    {
        ...
        public ResetIncreateHSMCJob(List<string> connectionStrings)
        {
            // Register this job with the hosting environment.
            // Allows for a more graceful stop of the job, in the case of IIS shutting down.
        ...
        private void ResetIncreate(MySqlConnection connection)
        {
            ...
            {
                context.RawModify("UPDATE increase SET `Value` = 0 where Name = 'Nhảy số HSMC';");
            }
        }
    }
}
