...
{
    internal class PdfToImage32
    {
        #region Static

        private const string GhostScriptDLLName = "gsdll32.dll";
        private const string GhostScriptKernel = "kernel32.dll";
        ...
        [DllImport(GhostScriptKernel, EntryPoint = "RtlMoveMemory")]
        ...
        public PdfToImage32(IntPtr objHandle)
        {
