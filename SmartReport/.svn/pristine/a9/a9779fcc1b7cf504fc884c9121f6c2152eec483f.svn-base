define([
    egov.mobile ? egov.template.transfer.transferMobile : egov.template.transfer.transfer,
    egov.mobile ? egov.template.transfer.transferItemMobile : egov.template.transfer.transferItem
],
