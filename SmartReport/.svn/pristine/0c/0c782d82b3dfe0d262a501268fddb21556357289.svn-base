...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.getScript("../../../../Scripts/bkav.egov/resource/egov.resources." + cultureName + ".js", function () {
    ...
    <form name="Config" method="post" action="Config" class="form">
        ...
        <div class="config" id="config">
            ...
            <div class="div-editor">
                ...
                <telerik:RadEditor ID="txtContent" Height="600px" Width="100%" ToolsFile="~/Toolbar.Xml"
