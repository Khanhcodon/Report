...
namespace Bkav.eGovCloud.Business.Customer
{
    ...
    /// 
    /// </summary>
    public class IndicatorBll : ServiceBase
    {
        private readonly IRepository<Indicator> _indicatorRepository;
        private readonly ResourceBll _resourceService;

        /// <summary>
        /// Khởi tạo class <see cref="IndicatorBll"/>.
        /// </summary>
        /// <param name="context">Context</param>
        /// <param name="resourceService"></param>
        public IndicatorBll(IDbCustomerContext context, ResourceBll resourceService)
            : base(context)
        {
            _indicatorRepository = Context.GetRepository<Indicator>();
        ...
        public void Create(IEnumerable<Indicator> indicator, bool ignoreExist = false)
        {
        ...
        private void Create(IEnumerable<Indicator> indicator)
        {
        ...
        public IEnumerable<Indicator> Gets(string sortBy = "", bool isDescending = false)
        {
            return _indicatorRepository.GetsReadOnly(null, Context.Filters.CreateSort<Indicator>(isDescending, sortBy));
        }
        ...
        /// <returns></returns>
        public IEnumerable<Indicator> Gets(Expression<Func<Indicator, bool>> spec = null)
        {
        ...
        public IEnumerable<TOutput> GetsAs<TOutput>(Expression<Func<Indicator, TOutput>> projector, Expression<Func<Indicator, bool>> spec = null)
        {
