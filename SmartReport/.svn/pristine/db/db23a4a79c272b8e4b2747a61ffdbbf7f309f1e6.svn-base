        ...
        public JsonResult Vote(string vote)
        {
            ...
            if (!string.IsNullOrEmpty(vote))
            {
                ...
                if (!string.IsNullOrEmpty(voteObj.VoteDetailId))
                {
                    ...
                    voteObj.UsersView = ConvertUsers(voteObj.UsersView);
                    if (voteObj.UsersView.Contains(";" + currentUserId.ToString() + ";") == false)
                    {
                        voteObj.UsersView = ConvertUsers(voteObj.UsersView) + currentUserId.ToString() + ";";
                    }

                    voteObj.UsersVote = ConvertUsers(voteObj.UsersVote);
