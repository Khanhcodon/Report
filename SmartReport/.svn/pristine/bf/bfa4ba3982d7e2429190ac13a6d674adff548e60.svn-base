define([
    egov.mobile ? "" : egov.template.survey,
    egov.mobile ? "" : egov.template.transfer.transferItem
],
    function (Template, UserItem) {
        ...
        var Transfer = Backbone.View.extend({
            ...
            serialize: function () {
                ...
                if (mainProcess) {
                    ...
                    if (userIdsDxl && userIdsDxl.length > 0) {
                        userIdsDxl = _.filter(userIdsDxl,
                            function (item) {
                ...
                if (egov.views.survey) {
                    ...
                    //targetComments = targetComments.concat(egov.views.survey.getDestination());
                    //extInfo = egov.views.survey.getExtInfo();
                    isDxl = false; //egov.views.survey.checkIsDongGui();
                    isThongbao = !isDxl;
            ...
            _renderDialog: function () {
                ...
                that.$listUser.empty();
                var dialogSetting = {
                    title: "Bàn giao phiếu khảo sát",//_resource.dialogTitle,
                    width: '900px',
                    draggable: true,
                    keyboard: true,
                    height: "auto",
