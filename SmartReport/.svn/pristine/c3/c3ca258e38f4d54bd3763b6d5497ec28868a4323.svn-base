...
WebDataRocksToolbar.prototype.getTabs = function () {
    ...
    // Connect tab
    tabs.push({
        title: "Kết nối", id: "wdr-tab-connect", icon: this.icons.connect,
        menu: [
            { title: "Kết nối từ file CSV", id: "wdr-tab-connect-local-csv", handler: this.connectLocalCSVHandler, mobile: false, icon: this.icons.connect_csv },
            { title: "Kết nối từ file JSON", id: "wdr-tab-connect-local-json", handler: this.connectLocalJSONHandler, mobile: false, icon: this.icons.connect_json },
             { title: "Kết nối từ DataBase", id: "wdr-tab-connect-local-json", handler: this.connectDB, mobile: false, icon: this.icons.connect },
        ]
    });
...
WebDataRocksToolbar.prototype.connectDB = function () {
    openConfigQuery()
}
