...
namespace Bkav.eGovCloud.DataAccess.Mapping.Customer
{
    ...
    /// </summary>
    [ComVisible(false)]
    public class DocPublishMapMySql : EntityTypeConfiguration<DocPublish>
    {
        ///<summary>
        /// Mapping property
        ///</summary>
        public DocPublishMapMySql()
        {
            ToTable("doc_publish");
            HasKey(p => p.DocumentPublishId);
    ...
    /// </summary>
    [ComVisible(false)]
    public class DocPublishMapSqlServer : EntityTypeConfiguration<DocPublish>
    {
        ///<summary>
        /// Mapping property
        ///</summary>
        public DocPublishMapSqlServer()
        {
            ToTable("doc_publish");
            HasKey(p => p.DocumentPublishId);
    ...
    /// </summary>
    [ComVisible(false)]
    public class DocPublishMapOracle : EntityTypeConfiguration<DocPublish>
    {
        ///<summary>
        /// Mapping property
        ///</summary>
        public DocPublishMapOracle()
        {
        }
    }
}
