...
(function ($) {
        ...
        _parts = {
            ...
            hex: function (inst) {
                ...
                _html = function () {
                    ...
                    html += '<input class="ui-colorpicker-hex-input" type="text" maxlength="6" size="6" style="width: 60px"/>';
	...
	$.widget("vanderlee.colorpicker", {
		options: {
			...
			buttonImage:        '/Scripts/jquery.colorpicker/images/ui-colorpicker.png',
