...
namespace Bkav.eGovCloud.Business.Customer
{
    ...
    /// </summary>
    public class DocumentPublishPlusBll : ServiceBase
    {
        private readonly IRepository<DocPublishPlus> _docpublishRepository;
        ...
        public DocumentPublishPlusBll(IDbCustomerContext context, NotificationBll notifyService)
            : base(context)
        {
            _docpublishRepository = Context.GetRepository<DocPublishPlus>();
            _notifyService = notifyService;
        }

        public DocPublishPlus GetDocPublishPlusByDocCopyId(int id)
        {
            return _docpublishRepository.Get(true, d => d.DocumentCopyId == id);
        }
        /// <summary>
        ...
        public void Create(DocPublishPlus docpublish)
        {
            if (docpublish == null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public List<DocPublishPlus> GetPending()
        {
        ...
        /// <returns></returns>
        public IEnumerable<DocPublishPlus> Gets(bool isReadonly, Expression<Func<DocPublishPlus, bool>> spec)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<DocPublishPlus> GetLienThongs()
        {
        ...
        /// <returns></returns>
        public List<DocPublishPlus> GetLienThongs(DateTime from, DateTime to, bool? isHSMC = null)
        {
            return _docpublishRepository.Gets(true, d => !d.IsPending &&
                        d.HasLienThong &&
        ...
        /// <returns></returns>
        public DocPublishPlus Get(int docPublishId)
        {
        ...
        /// <returns></returns>
        public List<DocPublishPlus> GetPendings(int docCopyId)
        {
        ...
        /// <returns></returns>
        public List<DocPublishPlus> GetSentPublishes(int docCopyId = 0)
        {
        ...
        /// <returns></returns>
        public List<DocPublishPlus> GetPublishes(int docCopyId)
        {
        ...
        /// <param name="docCopyId">Id văn bản</param>
        /// <returns></returns>
        public List<DocPublishPlus> GetPublishesForDelete(int docCopyId)
        {
        ...
        /// <summary>
        /// Update doc_publishplus
        /// </summary>
        public void Update(DocPublishPlus docPublishPlus)
        {
            Context.SaveChanges();
        }
        ...
        /// <param name="docCopyRelation"></param>
        /// <param name="note"></param>
        public void UpdateResponsed(DocPublishPlus publish, DocumentCopy docCopyResponsed, string note = "")
        {
            if (publish != null)
            {
                publish.IsResponsed = true;
        ...
        public void UpdateSendFail(DocPublishPlus docPublish, string message)
        {
